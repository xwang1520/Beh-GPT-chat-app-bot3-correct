...
- A vague reference alone (e.g., "the elf one", "that problem", "this question") is NOT sufficient context
...
If the CURRENT MESSAGE mentions CRT keywords but clearly lacks required context, or contains only vague references, respond:
